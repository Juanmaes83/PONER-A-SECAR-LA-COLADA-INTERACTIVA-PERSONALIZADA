...
// Build a real WebM in Chromium and feed it to the hanging-media input.
...
// Text must be visible, not merely present in DOM.
...
// Import asymmetric OBJ and add it to scene.
...
// Direct canvas selection by projected object center.
...
// Numeric rotation remains synchronized with the selected 3D root.
...
// Reload: hanging media, background, text/project layer and 3D instance must survive.
